    ...
    Column(
        ...
        ElevatedCard(
            ...
            Column(
                ...
                Row (
                    modifier = Modifier.background(Color.Green).height(25.dp),
                ...
                Text(
                    ...
                    Modifier.background(Color.LightGray).height(375.dp)
                )
                ...
                Text(
                    ...
                    Modifier.background(Color.Cyan).height(75.dp)
                )
                ...
                Text(
                    ...
                    Modifier.background(Color.Yellow).height(125.dp)
                )
            }
        }
